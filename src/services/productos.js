...
//create an funcion for get products for category and get products by id
export async function getProductos(categoria_id){
    try {
        // await new Promise(resolve=>setTimeout(resolve,2000));
        const {data} = await clientAxios.get(`/api/productos/categoria/${categoria_id}`);
        return data;
    } catch (error) {
...
export async function getProducto(id){
    try {
        const {data} = await clientAxios.get(`/api/productos/${id}`);
        return data;
    } catch (error) {
...
// export async function getProductos(categoria_id){
//   return productos.filter(producto=>producto.categoria_id===categoria_id);
// }
// export async function getProducto(id){
...
export async function getProductos2(){
  try {
    ...
    const respuesta=await clientAxios.get('/api/productos');
